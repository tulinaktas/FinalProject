...
{
    public class InMemoryProductDal : Abstract.InMemoryProductDal
    {
        List<Product> _products; //naming convension
        ...
        public void Delete(Product product)
        {
            ...
            */
            ...
            Product productToDelete = _products.SingleOrDefault
                (p => p.ProductId == product.ProductId); // productsı tek tek dolasmak
        ...
        {
            //Gönderilen urun idsine sahip olan listedeki urun bulunuyor
